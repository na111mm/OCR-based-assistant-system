...
#db_name = 'mysql+mysqlconnector://root:@localhost:3306/cystql?auth_plugin=mysql_native_password'
db_name = 'mysql+mysqlconnector://root:@localhost:3306/cystql?auth_plugin=mysql_native_password'#隐去了数据库访问密码
...
if __name__ == '__main__':
    ...
    def login():
        ...
        appID = ''  # 开发者关于微信小程序的appID，隐去了
        appSecret = ''  # 开发者关于微信小程序的appSecret，隐去了
